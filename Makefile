...
hd.img : out/boot.bin out/loader.bin out/kernel.bin out/demo.elf out/explorar.exe out/monilog.exe out/player.elf out/notepad.elf out/taskmgr.elf out/square.elf out/cube3d.elf pwd.txt music_vm.wav bgm.m4a bgm.wav version.txt tools/mkfat32.py
